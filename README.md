...
server. The time zone is set to UTC+1 Amsterdam.but can be changed <br />
...
<table style="width: 900px">
	<tr>
		...
		<p>- USE the BLE connection with an UART serial terminal app 
...
<br />
With the menu many settings can be set. <br />
Enter the letter of the item to be changed followed with the parameter.<br />
...
The restart the Pocuter by sending @ <br />
Entering b will show the used password.<br />
<br />
...
is chosen and the rest of the characters are coloured with the setting in Dimmed 
font.<br />
The format to be entered is hexadecimal. 0123456789ABCDEF are the character that 
can be used.<br />
To color the characters intense red enter FF0000 prefixed with the letter F, G 
or H.<br />
To set the background to intense blue enter: H0000FF<br />
To set the dimmed character to dark gray enter for example: G191919 </p>
<p><strong>I To print this Info menu</strong><br />
Print the menu <br />
<br />
<strong>L L0 = NL, L1 = UK, L2 = DE, L3 = FR, L4 = Wheel</strong><br />
You can choose between four languages to display or show them randomly<br />
<br />
<strong>N Display off between Nhhhh (N2208)</strong><br />
With N2208 the display will be off between 22:00 and 8:00<br />
<br />
...
BLE UART send packets of 20 bytes.Between every packet there is a delay of 50 
msec<br />
My IOS BLEserial app, and maybe other too, is able to receive packets of 80 
...
functionality was used.<br>In this software version only the Pocuter 
Button and OLED 
