...
--------------------------------------  
 ...
 Changes V051: Added possibilitie to send string in 20 byte chunck over BLE. UseBLELongString
...
<!DOCTYPE HTML><html><head>
  ...
  <p><span class="auto-style1"> Enter Time as: hhmmss (132145)<br>
    <strong>A</strong> SSID <strong>B</strong> Password <strong>C</strong> BLE Beacon name<br>
    <strong>D</strong> Set Date              D15012021)<br>
    <strong>E</strong> Set Timezone E<-02>2 or E<+01>-1<br>
&nbsp;  Make your own colour of:  (Hex RRGGBB)<br>
    <strong>F</strong> Font, <strong>G</strong> Dimmed font <strong>H</strong> Background<br>
...
&nbsp;   L3 = FR, L4 = Wheel<br>
    ...
    <strong>Q</strong> Display colour choice (Q0-Q6)<br>
    <strong>  Q0</strong> = Yellow    <strong>Q1</strong> = Hourly<br>
    <strong>  Q2</strong> = All white <strong>Q3</strong> = All Own<br>
    <strong>  Q4</strong> = Own       <strong>Q5</strong> = Wheel<br>
    <strong>  Q6</strong> = Digital display<br>
    <strong>R</strong> Reset settings <strong>@</strong> = Reset Pocuter<br>
    <strong>T</strong> Set Time                (T132145)<br>
    <strong>W</strong>=WIFI, <strong>X</strong>=NTP, 
    <strong>Y</strong>=BLE, <strong>Z</strong>=Fast BLE<br>
    <br>
